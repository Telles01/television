...
class SchemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scheme" do
    assert_difference("Scheme.count") do
      post schemes_url, params: { scheme: { address: @scheme.address, name: @scheme.name, rating: @scheme.rating } }
    end
  ...
  test "should update scheme" do
    patch scheme_url(@scheme), params: { scheme: { address: @scheme.address, name: @scheme.name, rating: @scheme.rating } }
